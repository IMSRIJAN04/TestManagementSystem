...
<h1 align="center">Select The Exam To Close</h1>

	<table border="3px" cellpadding="40px"  align="center" style="width: 800px;line-height: 40px;"border="1" border="1">
 <thead>
      <tr>
      <th>Test ID</th>
      <th>course id</th>
  ...
  <tbody>
    ...
    while ($res1 = mysqli_fetch_array($sql1)) 
    {
      ...
      <td><a href="stop.php?testid='.$res1['testid'].'">close test</a></td>
